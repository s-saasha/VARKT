...
plt.plot(t, v, 'b-', linewidth=2, label='Математическая модель')
...
plt.plot(t, h, 'b-', linewidth=2, label='Математическая модель')
...
plt.plot(t, m, 'b-', linewidth=2, label='Математическая модель')
